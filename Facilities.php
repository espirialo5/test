...
*/
ul:nth-of-type(1) li { background-image:url(images/Hotel.jpg);}
ul:nth-of-type(1) { width:120px; height:80px; }
ul:nth-of-type(2) li { background-image:url(images/Hotel.jpg);}
ul:nth-of-type(2) { width:90px; height:130px; }
ul:nth-of-type(3) li { background-image:url(images/Hotel.jpg);}
ul:nth-of-type(3) { width:130px; height:90px; }
ul:nth-of-type(4) li { background-image:url(images/Hotel.jpg);}
ul:nth-of-type(4) { width:120px; height:80px; }
ul:nth-of-type(5) li { background-image:url(images/Hotel.jpg);}
ul:nth-of-type(5) { width:64px; height:84px; }
ul:nth-of-type(6) li { background-image:url(images/Hotel.jpg);}
...
<div class="title">Castillo de Victoria Facilities</div>
<div class="gallery">
  <ul>
    <li>A</li>
    <li>B</li>
